...
def get_state_data(state_name):
    ...
    # GUJARAT DATA (Placeholder - Replace with your actual data)
        ...
        data = {
            ...
            "Alucolour": [0]*69,
            "Infinia": [*([0]*26),3,4,5,4,0,2,3,10,2,2,1,0,2,2,0,0,0,10,0,0,25,0,5,60,0,0,5,0,0,20,*([0]*10),15,0,25],
            "APL Apollo Rooftuff": [
        ...
        data = {
            ...
            "Popular": [100,205,75,220,25,250,15,270,286,23,35,80,30,15,8,50,20,110,160,30,20,10,35,40,25,40,80,25,55,40],
            "Alucolour": [0]*30,
            "Infinia": [0]*30,
        ...
        data = {
            "District": ['BANKURA','BIRBHUM','HOOGHLY','MEDINIPUR EAST','MEDINIPUR WEST','PASCHIM BARDHAMAN',
                         ...
                         'MALDAH'],
            "Popular": [160,70,330,170,160,140,320,140,320,140,120,110,120,130,105,60,10,25,75,15,30],
            "Alucolour": [0]*21,
            "Infinia": [0]*21,
